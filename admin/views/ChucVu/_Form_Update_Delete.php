        ...
        <div class="mb-3 row">
            ...
            <div class="col-6">
                ...
                if (isset($_GET['confirm'])) {
                    ...
                    echo '<div class="row">';
                    echo '<div class="col">';
                    echo '<a href="index.php?act=delcv&id=' . $kqOne['maCV'] . '" class="btn btn-sakura text-white">Xác nhận</a>';
                    echo '</div>';
                    echo '<div class="col">';
                    echo '<a href="index.php?act=chucvu" class="btn btn-sakura text-white">Quay lại</a>';
                    echo '</div>';
                }
                ?>
            </div>
